...
const MediaAnalyzer: React.FC = () => {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      if (selectedFile.size > 20 * 1024 * 1024) {
        alert("File size must be under 20MB for this demo.");
        return;
      }
  ...
  const handleAudit = async () => {
    ...
    try {
      ...
      alert("Failed to analyze media. Please check API key or file format.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-12">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-white">Content Auditor</h2>
        <p className="text-gray-400">Upload your drafts for AI-powered critique and improvement</p>
      </div>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            {preview ? (
              ...
              <div className="cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                ...
                <h3 className="text-lg font-medium text-white mb-2">Drop your content here</h3>
                <p className="text-sm text-gray-500">Support Video, Image, Audio (Max 20MB)</p>
          ...
          <div>
            ...
            <textarea 
              ...
              placeholder="Explain the goal of this video, intended music, or specific concerns..."
          ...
          >
            {loading ? 'Analyzing Content...' : '🔍 Run Audit'}
          </button>
        </div>
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-2 gap-4">
                 ...
                 <div className="bg-red-900/10 border border-red-900/30 p-4 rounded-xl">
                   <h4 className="text-red-400 font-semibold mb-2 flex items-center gap-2">⚠️ Weaknesses</h4>
                   <ul className="text-sm text-gray-300 space-y-1 list-disc list-inside">
              ...
              <div className="bg-brand-900/10 border border-brand-900/30 p-4 rounded-xl">
                 <h4 className="text-brand-300 font-semibold mb-2 flex items-center gap-2">💡 Key Suggestions</h4>
              ...
              <div className="flex justify-between items-center bg-dark-800 p-3 rounded-lg">
                <span className="text-gray-400 text-sm">Predicted Potential:</span>
